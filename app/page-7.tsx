    ...
    <div className="flex flex-col min-h-screen h-screen font-serif-1">
      ...
      <main className="flex flex-col flex-grow items-center  ">
        ...
        <div className="flex flex-wrap w-full p-4 gap-4">
          <div className="relative   bg-blue-500 flex items-center justify-center text-white w-[100vw] h-[100vw] md:w-[calc(50vw-1.5rem)]  md:h-[calc(50vw-1.5rem)] ">
            <Image
              src="/eov6.jpg"
              width={600}
              height={400}
            ...
            />
            <div className="absolute top-0 left-0 bottom-0 flex z-20 bg-black/10 w-full h-full ">
              sds
            </div>
          </div>
          <div className="relative   bg-blue-500 flex items-center justify-center text-white w-[100vw] h-[100vw] md:w-[calc(50vw-1.5rem)]  md:h-[calc(50vw-1.5rem)] ">
          ...
          <div className="relative   bg-blue-500 flex items-center justify-center text-white w-[100vw] h-[100vw] md:w-[calc(50vw-1.5rem)]  md:h-[calc(50vw-1.5rem)] ">
            <Image
              ...
              className="w-full h-full object-cover"
            />
            <div className="absolute top-0 left-0 bottom-0 flex z-20 bg-black/40 w-full h-full p-4 justify-end flex-col ">
              <p>sds</p>
              <p>sds</p>
            </div>
          </div>
          ...
          <div className="relative   bg-blue-500 flex items-center justify-center text-white w-[100vw] h-[100vw] md:w-[calc(50vw-1.5rem)]  md:h-[calc(50vw-1.5rem)] ">
            <Image
              ...
              className="w-full h-full object-cover"
            />
            <div className="absolute top-0 left-0 bottom-0 flex z-20 bg-black/50 w-full h-full ">
              sds
            </div>
          </div>
        </div>
...
const Property1 = () => {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      tl.addLabel("start")
        // .from(refImage.current, { scale: 0.3, autoAlpha: 0 })
        .from(refRoot.current, {
          maskImage:
        ...
        .to(refRoot.current, {
          maskImage:
            "linear-gradient(180deg, rgba(0,0,0,1) 90%, rgba(0,0,0,0) 90%)",
          // Works
          // x: 100,
          // duration: 1,
        })
  ...
  return (
    <div
      className="flex flex-row  justify-start relative w-full h-full"
      ref={refRoot}
    >
      <div className="image-holder px-8" ref={refImage}>
...
const WipeReveal = () => {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      gsap.fromTo(
        contentRef.current,
        { clipPath: "inset(0 100% 0 0)" }, // Start off-screen to the left
        {
          clipPath: "inset(0 0 0 0)", // Move to full width
          ease: "power1.inOut",
          scrollTrigger: {
  ...
  return (
    <div ref={sectionRef} className="wipe-section">
      <div className="content" ref={contentRef}>
        <h2>Your Title Here</h2>
        <Image src="/eov6.jpg" alt="Description" width={600} height={400} />
